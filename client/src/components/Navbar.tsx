  ...
  return (
    <nav className="bg-surface/50 sticky top-0 z-50 flex items-center justify-between px-4 py-3 shadow-xs backdrop-blur-xl md:px-8">
      ...
      <div className="flex items-center gap-6 text-[13px] font-semibold">
        ...
        <Link
          to="/intro"
          className="bg-primary focus-visible:ring-primary hover:bg-primary-hover rounded-lg p-2 text-pretty text-white outline-0 transition-colors duration-300 focus-visible:ring-2 focus-visible:ring-offset-1 md:px-4 md:py-2.25"
        >
          Take the assessment
        </Link>
      </div>
