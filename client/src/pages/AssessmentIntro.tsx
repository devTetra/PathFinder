...
export const AssessmentIntro = () => {
  ...
  return (
    <main className="from-primary-soft via-background to-accent-wash flex min-h-screen items-center justify-center bg-linear-135 px-4 py-8">
      <section className="bg-surface border-border shadow-text-primary/10 w-[calc(100%-2rem)] max-w-md rounded-2xl border p-6 shadow-[0px_16px_48px] sm:p-8">
        ...
        <Link
          to="test"
          className="bg-primary hover:bg-primary-hover focus-visible:ring-primary text-surface block w-full rounded-lg p-3 text-center text-sm font-bold outline-0 transition-colors duration-300 focus-visible:ring-2 focus-visible:ring-offset-1"
        >
          Start
        </Link>
      </section>
